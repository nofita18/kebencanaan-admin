    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="GET" class="row mb-3">
                <div class="col-md-4">
                    <input type="text" name="search" class="form-control" placeholder="Cari nama barang / sumber / keterangan..." value="{{ request('search') }}">
                </div>
                        ...
                        @forelse ($logistik as $l)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('logistik-bencana.edit', $l->logistik_id) }}" class="btn btn-sm btn-warning">
                                        <i class="fa-solid fa-pen-to-square"></i> Edit
                                    </a>

                                    <form action="{{ route('logistik-bencana.destroy', $l->logistik_id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                        @csrf
                                        @method('DELETE')
