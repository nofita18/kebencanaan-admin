...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('donasi-bencana.update', $donasi->donasi_id) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="donatur_nama" id="donatur_nama"
                            class="form-control" value="{{ old('donatur_nama', $donasi->donatur_nama) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="jenis">Jenis Donasi</label>
                        <input type="text" name="jenis" id="jenis"
                            class="form-control" value="{{ old('jenis', $donasi->jenis) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="nilai">Nilai Donasi (Rp)</label>
                        <input type="number" step="0.01" name="nilai" id="nilai"
                            class="form-control" value="{{ old('nilai', $donasi->nilai) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @if ($donasi->bukti)
                            <img src="{{ asset('storage/donasi_bencana/' . $donasi->bukti) }}"
                    ...
                    <div class="form-group">
                        <label for="bukti">Ganti Bukti Donasi (Opsional)</label>
