...
<body>
                            ...
                            <form action="{{ route('kejadian-bencana.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_kejadian" class="form-control" required>
                                        ...
                                        <option value="Aktif"
                                            {{ old('status_kejadian') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="Selesai"
                                            {{ old('status_kejadian') == 'Selesai' ? 'selected' : '' }}>Selesai
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Tentukan ID menu yang harus terbuka
            const mapping = {
                'warga': 'data-warga',
                'kejadian-bencana': 'kejadian-bencana'
            };

            // Buka menu sesuai halaman aktif
            if (mapping[segment]) {
                document.getElementById(mapping[segment])?.classList.add('show');
            }
        });
    </script>
</body>
