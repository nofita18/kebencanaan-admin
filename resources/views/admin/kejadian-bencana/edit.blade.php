        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('kejadian-bencana.update', $kejadian->kejadian_id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rt" class="form-control"
                                        value="{{ old('rt', $kejadian->rt) }}" required>
                                </div>

                                <div class="form-group">
                                    <label>RW</label>
                                    <input type="text" name="rw" class="form-control"
                                        value="{{ old('rw', $kejadian->rw) }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($kejadian->foto)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $kejadian->foto) }}" alt="Foto kejadian"
