            ...
            <form action="{{ route('posko-bencana.update', $posko->posko_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="penanggung_jawab" id="penanggung_jawab"
                           class="form-control" value="{{ old('penanggung_jawab', $posko->penanggung_jawab) }}" placeholder="Opsional">
                </div>
                ...
                <div class="form-group">
                    ...
                    @if ($posko->foto)
                        <img src="{{ asset('storage/posko/' . $posko->foto) }}"
                             alt="Foto Posko" width="150" class="rounded mb-2">
                    @else
                ...
                <a href="{{ route('posko-bencana.index') }}" class="btn btn-secondary">Kembali</a>
            </form>
        </div>
    </div>
</div>
