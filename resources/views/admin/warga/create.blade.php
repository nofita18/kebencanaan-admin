        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#kejadian-bencana"
                            aria-expanded="{{ Request::is('kejadian-bencana*') ? 'true' : 'false' }}"
                            aria-controls="kejadian-bencana">
                            <i class="icon-layout menu-icon"></i>
                            <span class="menu-title">Kejadian Bencana</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse {{ Request::is('kejadian-bencana*') ? 'show' : '' }}"
                            id="kejadian-bencana">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('kejadian-bencana') ? 'active' : '' }}"
                                        href="{{ route('kejadian-bencana.index') }}">
                                        Lihat Data
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('kejadian-bencana/create') ? 'active' : '' }}"
                                        href="{{ route('kejadian-bencana.create') }}">
                                        Tambah Data
                                    </a>
                                </li>
                            </ul>
